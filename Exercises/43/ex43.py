...
class Scene( object ):
    ...
    def enter( self ):
        ...
        print( "Subclass it and implement the enter function." )
        exit(1)
...
class Death( Scene ):
    ...
    def enter( self ):
        print( Death.fQuips[randint( 0, len( self.fQuips )-1 )] )
        exit(1)
...
class LaserWearponArmory( Scene ):
    ...
    def enter( self ):
        ...
        lCode = f"{randint( 1, 9)}{randint( 1, 9)}{randint( 1, 9)}"
        lGuess = input( "[keypad]> " )
        lAttempts = 0

        while lGuess != lCode and lAttempts < 10:
...
class EscapePod( Scene ):
    ...
    def enter( self ):
        ...
        lGoodPod = randint( 1, 5 )
        lGuess = input( "[pod#]> " )

        if int( lGuess )  != lGoodPod:
            print( dedent( """
                You jump into pod {guess} and hit the eject button.
                The pod escapes into the void of space, then
            ...
            print( dedent( """
                You jump into pod {guess} and hit the eject button.
                The pod easily slides out into space heading into the
...
class Map( object ):
    ...
    fScenes = {
        ...
        'laser_weapon_armory': LaserWearponArmory(),
